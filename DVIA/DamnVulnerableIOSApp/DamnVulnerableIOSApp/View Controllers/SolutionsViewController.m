...
//
//  Created by Prateek Gianchandani on 1/17/14.
...
@interface SolutionsViewController () <UIWebViewDelegate, UITextFieldDelegate>
...
-(void)loadWebPage {
    ...
    NSURL *url = [NSURL URLWithString:kSolutionsPage];
